  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark" data-bg-img="images/bg/bg2.jpg">
      ...
      <div class="container" align="center">
        ...
        <p>&nbsp;</p>
        <p><a href="campaigns/start" class="btn btn-dark btn-theme-colored btn-x3">START A MEDICAL CAMPAIGN </a></p>
Raise money for every kind of medical treatment, bills, and expenses.<p>
If ever you require help raising funds for personal medical expenses or the medical expenses of someone you care about, Projectlive is committed to helping you meet that need. With one click you can begin a campaign that would put you on the path of healing and recovery. Whatever the illness, and however much treatment and the healing process cost, a fundraising campaign on Projectlive is bound to bring satisfying results       </div>
    <section>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
           ...
           <?php  //determine active tabs//
               $category='Medical'; // project category page default
            ...
            <div class="horizontal-tab-centered text-left ">
                <ul class="nav nav-pills mb-8">
                 <li class="<?php if($active_tab==1){echo 'active';} else {echo '';}?>"> <a href="medical-fundraising?ref=all" data-toggle="tooltip" data-placement="right" title="This will display projects under the medical category but with no particular order." class="active">All</a> </li>

                  <li class="<?php if($active_tab==2){echo 'active';} else {echo '';}?>"> <a href="medical-fundraising?ref=recent" data-toggle="tooltip" data-placement="right" title="This will display the current projects under medical category."  class=""><strong>Recent Projects</strong></a></li>
                   <li class="<?php if($active_tab==3){echo 'active';} else {echo '';}?>"><a href="medical-fundraising?ref=most funded" data-toggle="tooltip" data-placement="right" title="This will display projects under the medical category that are most funded."  class=""><strong>Most Funded</strong></a> </li>
                 
                  <li class="<?php if($active_tab==4){echo 'active';} else {echo '';}?>"> <a href="medical-fundraising?ref=ending soon" data-toggle="tooltip" data-placement="right" title="This will display projects under the medical category that are ending soon."  class=""><strong>Ending Soon</strong></a> </li>
                   <li class="<?php if($active_tab==5){echo 'active';} else {echo '';}?>"> <a href="medical-fundraising?ref=ended" data-toggle="tooltip" data-placement="right" title="This will display projects under the medical category already ended." class=""><strong>Ended</strong></a>
              </li>
                </ul>
            </div>
...
<?php // if reference is not set, display the filter guide that carries ALL, just as the using in the switch case above. this issue is neccessary bcus on initail page visit $_GET is not yet set atall//
      ...
      if(!isset($_GET['ref'])){
        ...
        echo '<i style="float:left">Showing campaigns under <strong class="text-theme-colored">Medical</strong> that are: <strong class="text-theme-colored">Available</strong></i>';
      }?>

<?php  // if reference is set, and the  filter category selected is all then change the grammer//
     if(isset($_GET['ref'])){
        echo '<i style="float:left">Showing campaigns under <strong class="text-theme-colored">Medical</strong> that are: <strong class="text-theme-colored">';
