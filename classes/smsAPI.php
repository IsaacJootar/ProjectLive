...
class MyMobileAPI
{
    ...
    public function __construct() {
        $this->url = 'http://www.loftysms.com';
        $this->username = 'projectlive'; //your login username
        $this->password = 'passwordizicc0011,.,.'; //your login password
    }
...
//$test->sendSms('08069504309','Test Message'); //Send SMS
