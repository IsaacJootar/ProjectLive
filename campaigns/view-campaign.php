...
<div class="main-content">
  ...
  <div class="container">
       ...
       <h3 align="left" class="media-heading text-uppercase font-weight-500"> Campaign Tittle: <?php echo   $campaign_basics->campaign_tittle; ?>  </h3>
        <h5 align="left" font-weight-500>Campaign Tagline: <?php  if(!empty($campaign_basics->campaign_tagline)) {
          echo $campaign_basics->campaign_tagline; 
        }else{ echo '-----?';} ?>  </h5>
