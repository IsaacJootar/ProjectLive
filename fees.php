...
body,td,th {
  ...
  <div class="main-content">
        ...
        <div class="section-content text-center">
          <div class="row"> 
            <div class="col-md-12  text-center">
              <h2 class="text-white font-25" align="center">TELL YOUR STORY TO OUR ONLINE COMMUNITY  AND FIND DONORS WILLING TO FUND YOUR IDEA, CAUSE OR CREATIVE PROJECT</h2>
    ...
    <section>
            ...
            <div class="col-md-12  text-center">
              <h2>Our Fees.</h2>
              <h4>ProjectLive applies one of the lowest platform and card prcessing fees among crowdfunding platforms worldwide. The following fees apply to all donations. Card processing fees only apply to online payments, charged by our card processing partners. </h4>
        ...
        <div class="row text-center">
          <div class="col-sm-4">
            <div class="icon-box iconbox-theme-colored bg-lighter">
              ...
              <h4>ProjectLive Platform fee.
</h4><h2>5%  on each donation</h2>
             <p class="text-gray"><div class="text-justify">5% fee applies to creators, ProjectLive does NOT charge donors!</div>
          ...
          <div class="col-sm-4">
            <div class="icon-box iconbox-theme-colored bg-lighter">
              ...
              <h4>Payment Processing for Local Transactions
</h4><h2>1.5% + NGN 100</h2>
             <p class="text-gray"><div class="text-justify">₦100 fee waived for transactions under ₦2500.</div>


</p>
 <p class="text-gray">
  <div class="text-justify">Payment Processing  for Local transactions fees are capped at ₦2000, meaning that's the absolute maximum your campaign will ever be charge in fees per transaction.  </div>
          ...
          <div class="col-sm-4">
            <div class="icon-box iconbox-theme-colored bg-lighter">
              ...
              <h4>Payment Processing for International Transactions
</h4><h2>3.9% + NGN 100</h2>
             <p class="text-gray"><div class="text-justify">₦100 fee waived for transactions under ₦2500.</div>


</p>
 <p class="text-gray"><div class="text-justify">International cards are charged and settled in Naira by default.</div>
    ...
    <div class="row mt-30">
          ...
          <div class="col-sm-3">
            <div class="icon-box iconbox-theme-colored">
              ...
              <p class="text-gray"> <div class="text-justify">Start recieving funds from willing donors all over Africa. Monitor your funds in realtime as they come in.</p>
            </div>
          </div>
          </div>
          <div class="col-sm-3">
            <div class="icon-box iconbox-theme-colored">
              ...
              <p class="text-gray"><div class="text-justify">Use the funds you have recieved to execute the project. Appreciate your donors and share your success story to our community. Simply!</p>
            </div>
          </div>
          </div>
        </div>
