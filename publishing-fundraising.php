  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark" data-bg-img="images/bg/bg2.jpg">
      ...
      <div class="container" align="center">
        ...
        <p>&nbsp;</p>
        <p><a href="campaigns/start" class="btn btn-dark btn-theme-colored btn-x3">START A PUBLISHING CAMPAIGN </a></p>
Raise funds to publish that book.
Get that manuscript off the shelf and get it published – Projectlive is committed to helping you raise the fund you need. Let the world enjoy your literary skills, don’t be hindered by lack of finance; start a fundraising campaign on Projectlive today. 
       </div>
    <section>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
           ...
           <?php  //determine active tabs//
               $category='Publishing'; // project category page default
            ...
            <div class="horizontal-tab-centered text-left ">
                <ul class="nav nav-pills mb-8">
                 <li class="<?php if($active_tab==1){echo 'active';} else {echo '';}?>"> <a href="publishing-fundraising?ref=all" data-toggle="tooltip" data-placement="right" title="This will display projects under the publishing category but with no particular order." class="active">All</a> </li>

                  <li class="<?php if($active_tab==2){echo 'active';} else {echo '';}?>"> <a href="publishing-fundraising?ref=recent" data-toggle="tooltip" data-placement="right" title="This will display the current projects under publishing category."  class=""><strong>Recent Projects</strong></a></li>
                   <li class="<?php if($active_tab==3){echo 'active';} else {echo '';}?>"><a href="publishing-fundraising?ref=most funded" data-toggle="tooltip" data-placement="right" title="This will display projects under the publishing category that are most funded."  class=""><strong>Most Funded</strong></a> </li>
                 
                  <li class="<?php if($active_tab==4){echo 'active';} else {echo '';}?>"> <a href="publishing-fundraising?ref=ending soon" data-toggle="tooltip" data-placement="right" title="This will display projects under the publishing category that are ending soon."  class=""><strong>Ending Soon</strong></a> </li>
                   <li class="<?php if($active_tab==5){echo 'active';} else {echo '';}?>"> <a href="publishing-fundraising?ref=ended" data-toggle="tooltip" data-placement="right" title="This will display projects under the publishing category already ended." class=""><strong>Ended</strong></a>
              </li>
                </ul>
            </div>
...
<?php // if reference is not set, display the filter guide that carries ALL, just as the using in the switch case above. this issue is neccessary bcus on initail page visit $_GET is not yet set atall//
      ...
      if(!isset($_GET['ref'])){
        ...
        echo '<i style="float:left">Showing campaigns under <strong class="text-theme-colored">Publishing</strong> that are: <strong class="text-theme-colored">Available</strong></i>';
      }?>

<?php  // if reference is set, and the  filter category selected is all then change the grammer//
     if(isset($_GET['ref'])){
        echo '<i style="float:left">Showing campaigns under <strong class="text-theme-colored">Publishing</strong> that are: <strong class="text-theme-colored">';
