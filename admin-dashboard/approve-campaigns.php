<?php include ('includes/header.php');?>
    <div class="" align="left">
        <h2 class="heading-border">Approve Campaigns.</h2>
      </div>
...
?>
          ...
          <i class="fa fa-user text-theme-colored mr-5"> <?php  echo ucfirst(strtolower($get_user_name->first_name));?> 
                ...
                <p><?php echo $campaign_basics->campaign_tagline;?></p>
                 ...
                 <p><a class="btn btn-dark btn-theme-colored btn-flat btn-sm pull-left mt-10" href="approve-campaigns_?ref=<?php echo urlencode(str_replace(' ', '-', $campaign_basics->campaign_tittle)); ?>">Vet this campaign</a></p>
                 <p>&nbsp;</p>
